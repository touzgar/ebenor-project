...
export default function ProductBulkActions({
  ...
  const executeBulkAction = async (action: BulkAction, data?: any) => {
    ...
    try {
      const response = await productsService.bulkOperations({
        action,
      ...
      if (response.success) {
        const actionMessages = {
          delete: `${selectedCount} produit(s) supprimé(s) avec succès`,
          feature: `${selectedCount} produit(s) mis en vedette`,
          unfeature: `${selectedCount} produit(s) retirés de la vedette`,
          changeCategory: `Catégorie changée pour ${selectedCount} produit(s)`,
        };
  ...
  const handleCategorySubmit = () => {
    ...
    executeBulkAction('changeCategory', categoryData);
  };
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={onClear}
              disabled={isProcessing}
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-neutral-700 bg-white border border-neutral-300 rounded-lg hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Annuler
            </button>
          </div>
              ...
              <div className="flex items-start mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-neutral-600">
                    ...
                    <span className="font-semibold">{selectedCount}</span> produit
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCategoryData({ ...categoryData, subcategory: e.target.value })
                    }
                    placeholder="Ex: Cuisine moderne, Armoire sur mesure..."
                    className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  />
                </div>
              </div>
