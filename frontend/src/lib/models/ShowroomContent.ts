...
export const ShowroomContent = (mongoose.models.ShowroomContent as Model<IShowroomContent>) || mongoose.model<IShowroomContent>('ShowroomContent', ShowroomContentSchema);
